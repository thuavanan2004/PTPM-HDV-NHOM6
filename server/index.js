...
// cấu hình bên client gọi về
app.use((req, res, next) => {
  // Thêm header CORS cho mọi yêu cầu
  res.header('Access-Control-Allow-Origin', '*'); // Cho phép yêu cầu từ localhost:5173
  res.header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS, PATCH'); // Các phương thức HTTP được phép
